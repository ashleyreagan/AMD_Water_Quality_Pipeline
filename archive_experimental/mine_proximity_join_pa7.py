#!/usr/bin/env python3
"""
mine_proximity_join_pa7.py
Optimized Step 4 – Pennsylvania AMD workflow

Joins WQX chemistry sites to nearest mine/AML features using STRtree.
Includes:
 • Parallel chunking with graceful fallback
 • Auto resume from checkpoints
 • QC logging + safe append writes
 • Warning suppression for cleaner logs
 • Stable performance tuning for Apple M-series
